...
import 'package:chefstation_multivendor/features/order/domain/models/delivery_log_model.dart';
import 'package:chefstation_multivendor/features/order/domain/models/order_cancellation_body.dart';
import 'package:chefstation_multivendor/features/order/domain/models/order_model.dart';
import 'package:chefstation_multivendor/features/order/domain/models/pause_log_model.dart';
import 'package:chefstation_multivendor/features/order/domain/models/refund_model.dart';
...
class OrderRepository implements OrderRepositoryInterface {
  ...
  Future add(value) async {
    // Implementation for adding orders - typically not needed for customer app
  ...
  Future delete(int? id) async {
    // Implementation for deleting orders - typically not needed for customer app
    // This method is part of the interface but not used in customer context
    return Future.value();
  }
  ...
  Future update(Map<String, dynamic> body, int? id) async {
    // Implementation for updating orders - typically not needed for customer app
    // This method is part of the interface but not used in customer context
    return Future.value();
  }
