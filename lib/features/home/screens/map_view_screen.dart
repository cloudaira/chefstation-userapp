...
import 'package:chefstation_multivendor/features/home/widgets/google_map_widgets/restaurant_search_widget.dart';
import 'package:chefstation_multivendor/features/home/widgets/map_custom_info_window_widget.dart';
import 'package:chefstation_multivendor/features/home/widgets/google_map_widgets/restaurant_details_sheet_widget.dart';
...
import 'package:chefstation_multivendor/features/location/widgets/permission_dialog.dart';
  ...
  void _setMarkers(List<Restaurant> restaurants, bool selected, {AddressModel? address}) async {
    try{
      ...
      _markers.add(Marker(
        ...
        icon: BitmapDescriptor.bytes(myLocationMarkerIcon),
      ));
      ...
      for(int index=0; index<restaurants.length; index++) {
        ...
        _markers.add(Marker(
          ...
          icon: BitmapDescriptor.bytes(restaurantMarkerIcon),
        ));
      }
